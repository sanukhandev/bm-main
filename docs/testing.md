...
### Customer profile payment workflow

Customer profile regression coverage verifies branch-scoped owner and tenant
agreement/payment-line data, omission of financial lines without `accounts.view`,
and reuse of the existing property, agreement, and payment posting screens.
Owner additional payment lines post outward; tenant additional payment lines
post inward. Particulars remain user-entered while receipt/voucher numbering is
