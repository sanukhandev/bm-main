...
- **2026-09-26**: Completed the safe backend consolidation pass on `cleanup/backend-consolidation`: restored PHPUnit execution, removed proven-dead Zaakiy and agreement-transition wrappers, centralized work-order status mutation, customer-vendor mechanics, occupancy and outstanding-installment queries, payment-line immutability, and decimal amount conversion, with compatibility and branch/report parity coverage.
